...
import com.example.ahmetanilgur.fakearmut.ListOfDayRequestsActivity;
...
public class ActionReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if(action.equals("accept")){
            ...
            notificationManager.cancel(NotificationUtils.WATER_REMINDER_NOTIFICATION_ID);
                        ...
                        public void onResponse(String response) {
                            ...
                            if(dayreqjsonarray.length()<2){
                                ...
                                try {
                                    ...
                                    try {
                                        Toast.makeText(context, "You have accepted "+username+"\'s request for "+ dayreqjsonarray.getString(0)+"!",
                                                Toast.LENGTH_LONG).show();
                                    } catch (JSONException e) {
                                        e.printStackTrace();
                                    }
